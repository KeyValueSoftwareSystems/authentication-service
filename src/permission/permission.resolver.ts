...
export class PermissionResolver {
    ...
    @Mutation()
    async createPermission(@Args('input') userInput: NewPermissionInput): Promise<Permission> {
    ...
    @Mutation()
    async deletePermission(@Args('id', ParseUUIDPipe) id: string): Promise<Permission> {
